...
export async function GET(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    if (!parsedLanguage.success
      ...
      return apiError("제공 중인 언어를 선택하세요.", "LANGUAGE_REQUIRED", 400, privateNoStoreHeaders());
    }
    ...
    return apiError("참가자 활동을 읽을 수 없습니다.", "PARTICIPANT_ACTIVITY_READ_FAILED", 500, privateNoStoreHeaders());
  }
}
