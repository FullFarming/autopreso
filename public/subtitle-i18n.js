...
const EN = {
  ...
  "cfg.displayMode": "Display Mode",
  "displayMode.translationOnly": "Translation only",
  "displayMode.translationSource": "Original plus every selected language",
  "displayMode.hint": "By default only the other side shows: Korean speech → English only, English speech → Korean only.",
  ...
  "settings.openConsole": "Console",
  "settings.consoleOpenFailed": "The console could not be opened. Check your sign-in and try again.",
  ...
  "hostSession.deepLinkFailed": "Could not confirm the sign-in from your browser. Please try again.",
  ...
  "controller.engine": "Caption engine status",
  "controller.engineConnecting": "Engine connecting",
  "controller.engineReady": "Engine ready",
  "controller.engineFailed": "Engine failed",
...
const KO = {
  ...
  "cfg.displayMode": "표시 방식",
  "displayMode.translationOnly": "번역만 표시",
  "displayMode.translationSource": "원문과 선택한 모든 언어 동시 표시",
  "displayMode.hint": "기본은 인입 언어의 반대편 번역만 보여줍니다. 한국어로 말하면 영어만, 영어로 말하면 한국어만 나옵니다.",
  "cfg.glossary": "용어집",
  ...
  "settings.openConsole": "콘솔",
  "settings.consoleOpenFailed": "콘솔을 열 수 없어요. 로그인 상태를 확인한 뒤 다시 시도해 주세요.",
  "hostSession.loginTitle": "NOVA 로그인",
  "hostSession.verifyFailed": "로그인 상태를 확인하지 못했어요. 연결을 확인한 뒤 다시 확인해 주세요.",
  "hostSession.deepLinkFailed": "시스템 브라우저 로그인을 확인하지 못했습니다. 다시 시도해 주세요.",
  ...
  "controller.engine": "자막 엔진 상태",
  "controller.engineConnecting": "엔진 연결 중",
  "controller.engineReady": "엔진 준비됨",
  "controller.engineFailed": "엔진 오류",
