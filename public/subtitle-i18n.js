...
const EN = {
  ...
  "live.displayLanguage": "Screen caption language",
  "live.displayLanguageHelp": "The screen shows one selected language; web history keeps both EN and KO.",
...
const KO = {
  ...
  "live.language": "언어",
  "live.displayLanguage": "화면 자막 언어",
  "live.displayLanguageHelp": "화면에는 선택한 한 언어만 표시하고, 웹 기록에는 EN·KO를 모두 유지합니다.",
  "live.access": "입장 · 정원",
